...
public class HammockHotel {
     ...
     */
     ...
     /**
      * Method addUnique takes parameter String guestName and passes this parameter
      * to method contains to check if the guestName is unique, if unique
      * method add is called to add the guestName to its appropriate position
     ...
     */
     ...
     /**
      * Method isEmpty checks to see if this.usage == 0, if so the
     ...
     */
     ...
     /**
      * Method toArray initializes a new String array to be length of this.usage,
    ...
    /**
     * The method clear sets the first Node at each index in the array 
     * rooms to be null, resulting in the elements in the array to be "cleared",
     ...
     */
      ...
      * the array is returned after all Nodes within the array rooms is
      * checked.
      * */
    public int[] stats() {
